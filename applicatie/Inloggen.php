...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["username1"]) && isset($_POST["password1"])) {
    ...
    if ($user) {
        // DIt kan ook makkelijker door alle data van $user in eeen array te stoppen en dan elke keer de session aan te roepen met $user
        // en dan de het specifieke veld opvragen
        if (password_verify($password, $user['password'])) {
            ...
            if ($user['role'] == 'Personnel') {
                $_SESSION["medewerker_ingelogd"] = true;
            }
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["username2"]) && isset($_POST["password2"])) {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            $sql = "INSERT INTO [User] (username, password, first_name, last_name, address, role) VALUES (:username, :password, :voornaam, :achternaam, :address, 'Client')";
            $stmt = $connect->prepare($sql);
            $stmt->bindParam(':username', $username);
...
<body>
    <main>
        ...
        <form method="post">
            ...
            <br>
            <button type="submit" id="login_knop2">Login</button>
        </form>
        <p><?php if (isset($melding)) echo $melding; ?></p>
    </main>
</body>
</html> -->
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to gelre airpoit, gelre.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to gelre airport, accessible from <a href="gelre-airport.nl" rel="external nofollow noopener" target="_blank">gelre-airport.nl</a></p>
</li>
<li>
...
<ul>
<li>By email: gelre@gelre.com</li>
</ul>
    </main>
</body>
</html>
